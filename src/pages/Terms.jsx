    ...
    <Layout>
      <div className="container mt-5">
        ...
        <p>
          ...
          KAPESTAR PRIVATE LIMITED''s relationship with you in relation to this
          website.
        </p>

        <p>
          The term 'KAPESTAR PRIVATE LIMITED' or 'us' or 'we' refers to the
          owner of the website whose registered/operational office is 4/A Surath
          Ch Bose Lane, Ghosal Bagan, Konnagar, Hooghly, West Bengal, India,
          712235 Hooghly WEST BENGAL 712235. The term 'you' refers to the user
        ...
        >
          ...
          <li>
            ...
            document without KAPESTAR PRIVATE LIMITED’s prior written consent.
          </li>
